...
describe('Performance Tests', () => {
  ...
  describe('Memory Usage Tests', () => {
    it('should maintain memory usage below 800MB during processing', async () => {
      ...
      console.log(
        `Memory usage: Initial=${initialMemory.toFixed(2)}MB, Final=${finalMemory.toFixed(2)}MB, Increase=${memoryIncrease.toFixed(2)}MB`
      );
    }, 20000);
    ...
    it('should release memory after processing each configuration', async () => {
      ...
      console.log(
        `Multi-config memory: Initial=${initialMemory.toFixed(2)}MB, Final=${finalMemory.toFixed(2)}MB, Increase=${memoryIncrease.toFixed(2)}MB`
      );
    }, 30000);
    ...
    it('should handle memory efficiently with different render modes', async () => {
      ...
      console.log(
        `1-bit render mode memory: Initial=${initialMemory.toFixed(2)}MB, Final=${finalMemory.toFixed(2)}MB`
      );
    }, 15000);
  ...
  describe('Performance Regression Tests', () => {
    it('should maintain consistent performance across multiple runs', async () => {
      ...
      console.log(
        `Performance consistency: Avg=${avgDuration.toFixed(0)}ms, Min=${minDuration}ms, Max=${maxDuration}ms, Variance=${variance}ms`
      );
