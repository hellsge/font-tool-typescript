...
describe('Feature: typescript-font-converter, Property 20: CLI 参数覆盖配置文件', () => {
  ...
  it('should override fontSize when size is provided', () => {
    fc.assert(
      fc.property(fontConfigArbitrary, fc.integer({ min: 1, max: 255 }), (config, newSize) => {
  ...
  it('should override bold when bold is provided', () => {
    fc.assert(
      fc.property(fontConfigArbitrary, fc.boolean(), (config, newBold) => {
  ...
  it('should override italic when italic is provided', () => {
    fc.assert(
      fc.property(fontConfigArbitrary, fc.boolean(), (config, newItalic) => {
  ...
  it('should override renderMode when renderMode is provided', () => {
    fc.assert(
      fc.property(fontConfigArbitrary, renderModeArbitrary, (config, newRenderMode) => {
  ...
  it('should override outputPath when outputPath is provided', () => {
    fc.assert(
      fc.property(fontConfigArbitrary, fc.string({ minLength: 1 }), (config, newOutputPath) => {
  ...
  it('should override rotation when rotation is provided', () => {
    fc.assert(
      fc.property(fontConfigArbitrary, rotationArbitrary, (config, newRotation) => {
  ...
  it('should only override specified properties', () => {
    fc.assert(
      fc.property(fontConfigArbitrary, cliOverridesArbitrary, (config, overrides) => {
